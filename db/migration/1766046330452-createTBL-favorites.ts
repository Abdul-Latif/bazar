...
export class CreateTBLFavorites1766046330452 implements MigrationInterface {
    name = 'CreateTBLFavorites1766046330452'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "favorites" ("id" SERIAL NOT NULL, "Created_Date" TIMESTAMP NOT NULL DEFAULT now(), "Updated_Date" TIMESTAMP NOT NULL DEFAULT now(), "Deleted_Date" TIMESTAMP, "userId" integer, "productId" integer, CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`);
